              ...
              <div class="card-body" >
                ...
                <form role="form" action="/users"method="POST">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="text" name="name" class="form-control" value="{{old('name')}}" placeholder="Name" aria-label="Name">
                    @error('name')
                  ...
                  <div class="mb-3">
                    <div class="col-md-6 ps-md-2">
                      <div class="input-group input-group-static mb-4">
                    <input type="password"name="password" class="form-control" value="{{old('password')}}" placeholder="Password" aria-label="Password">
                    @error('password')
                    <p class="text-red-500 text-xs mt-1">{{$message}}</p>
                    @enderror
                      </div>
                  ...
                  <div class="mb-3">
                    <div class="col-md-6 ps-md-2">
                      <div class="input-group input-group-static mb-4">
                    <input type="password" name="password_confirmation" value="{{old('password_confirmation')}}" class="form-control" placeholder="Confirm Password" aria-label="Password">
                ...
                <div class="col-md-6 ps-md-2">
                  <div class="input-group input-group-static mb-4">
                    ...
                    <select name="role" >
                      ...
                      <option value="engineer_GC">Civil Engineer</option>
